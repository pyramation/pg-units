-- Deploy schemas/units/tables/quantity/fixtures/1601179866631_fixture to pg

-- requires: schemas/units/schema
-- requires: schemas/units/tables/quantity/table
...
INSERT INTO units.quantity (id, name, label, unit, unit_desc, description) VALUES
